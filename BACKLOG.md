...
- [x] Documentar resultados finais e próximos passos em README/notes
...
- [x] Definir fakes/stubs para Kafka/ClickHouse/Redis e evitar IO real em unit
...
- [x] Padronizar testes com RTL + msw para HTTP; evitar chamadas reais
- [x] Documentar comandos em README (ex.: `npm test -- --coverage` ou `vitest run --coverage`)
