-- Revert pricing plans to previous baseline values
INSERT INTO pricing_plans AS p (
    ...
    ('starter', 'Starter', true, 1, 2, 1, 1, 5, CURRENT_TIMESTAMP),
    ('pro', 'Pro', false, 2, 4, 2, 6, 20, CURRENT_TIMESTAMP),
    ('professional', 'Professional', false, 1, 2, 1, 1, 4, CURRENT_TIMESTAMP),
    ('enterprise', 'Enterprise', false, 1, 2, 1, 1, 3, CURRENT_TIMESTAMP)
