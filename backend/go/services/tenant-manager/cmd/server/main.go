...
func main() {
	...
	// Swagger metadata for generated docs
	docs.SwaggerInfo.BasePath = "/api/v1"
	docs.SwaggerInfo.Title = "Tenant Manager API"
	docs.SwaggerInfo.Version = serviceVersion
	docs.SwaggerInfo.Description = "Tenant and API key management service"
...
func startHTTPServer(cfg *config.Config, deps *Dependencies, log *zap.Logger) *http.Server {
	...
	// Serve static OpenAPI docs (legacy)
	r.Static("/docs", "./api/openapi")

	// Swagger UI and spec generated by swag (align with default /swagger/index.html)
