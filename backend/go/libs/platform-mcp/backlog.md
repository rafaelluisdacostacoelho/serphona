...
- [ ] Formalizar esquema/compatibilidade (protobuf vs JSON), publicar fixtures externos.
...
- [ ] Alinhar payloads com PROMPTS-YAML-SPEC e definir allow-list por tenant.
...
- [ ] Propagar session_id/tenant em audit/telemetria.
...
- [ ] MCP message golden vectors (ok/error/cancel/unsupported)
- [ ] Policy allow/deny matrix and precedence
- [ ] Registry cache/fallback/ETag behavior
- [ ] Invocation retries/backoff/circuit and rate limits
- [ ] Envelope contract and header parsing fuzz
